...
def extract_opto(path: str, ts: int):
    '''
    ...
    _, system = neuron_system(t, s, int(72000 / BIN))
...
def mean_and_ci(a: np.ndarray, pct: int):
    '''
    Given an array in the form generated by `main_analysis` from `analysis_pnas.py`, returns the experiment-averaged mean and confidence interval.
